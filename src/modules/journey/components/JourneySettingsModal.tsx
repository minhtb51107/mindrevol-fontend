...
import { X, Loader2, LogOut, Trash2, UserCog, Globe, Lock } from 'lucide-react';
        ...
        <div className="w-full max-w-lg bg-[#18181b] border border-white/10 rounded-2xl flex flex-col max-h-[90vh]">
          ...
          {isOwner && (
            <div className="p-6 border-t border-white/5 flex justify-end">
              <button onClick={handleSave} disabled={isLoading} className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-blue-900/20">
