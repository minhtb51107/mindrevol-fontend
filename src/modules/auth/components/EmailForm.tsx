...
// --- CONFIG ---
// Thay bằng biến môi trường hoặc key thật của bạn
const FACEBOOK_APP_ID = import.meta.env.VITE_FACEBOOK_APP_ID || "1578813576625180"; 
const TIKTOK_CLIENT_KEY = import.meta.env.VITE_TIKTOK_CLIENT_KEY || "awosim1vhbq5dy30"; 
// Dùng Ngrok cho Redirect URI
const TIKTOK_REDIRECT_URI = import.meta.env.VITE_TIKTOK_REDIRECT_URI || "https://elfrieda-unhollowed-marcelle.ngrok-free.dev/tiktok-callback";
// -------------
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        {/* Nút TikTok - Đã sửa lỗi icon biến mất */}
        <Button 
            variant="outline" 
            type="button" 
        ...
        >
            {!isLoading && (
               /* Bỏ class text-black/white để icon tự động ăn theo màu chữ của nút */
