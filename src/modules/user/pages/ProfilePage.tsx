...
const ProfilePage = () => {
  ...
  return (
    // [THAY ĐỔI LỚN] Bọc trong MainLayout, xóa class absolute inset-0
    <MainLayout>
      <div className="w-full min-h-screen bg-[#121212] text-white">
        
        {/* HEADER (Đổi từ fixed sang sticky để nằm gọn trong layout) */}
        <div className="sticky top-0 z-50 flex items-center justify-between p-4 bg-gradient-to-b from-[#121212] via-[#121212]/90 to-transparent pointer-events-none pb-8">
            {/* <button 
               onClick={() => navigate(-1)} 
               className="p-2.5 bg-black/60 hover:bg-black/80 backdrop-blur-xl rounded-full text-white transition-all border border-white/10 pointer-events-auto"
            >
